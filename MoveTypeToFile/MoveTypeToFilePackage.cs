...
namespace MoveTypeToFile
{
    ...
    [Guid(MoveTypeToFilePackage.PackageGuidString)]
    ...
    public sealed class MoveTypeToFilePackage : AsyncPackage
    {
        ...
        /// <summary>
        /// MoveTypeToFilePackage GUID string.
        /// </summary>
        public const string PackageGuidString = "40359667-4b95-4c95-9f5d-feeded7fd198";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await MoveTypeToFileCommand.InitializeAsync(this);
        }
